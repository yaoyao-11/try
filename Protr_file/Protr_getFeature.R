...
aaOut.out=aaOut.o[-1,]
write.csv(aaOut.out,"./train_P_AAC.csv")
...
aaOut.out=aaOut.o[-1,]
write.csv(aaOut.out,"./train_P_PAAC.csv")
...
aaOut.out=aaOut.o[-1,]
write.csv(aaOut.out,"./train_P_CTDC.csv")
...
aaOut.out=aaOut.o[-1,]
write.csv(aaOut.out,"./train_P_CTDT.csv")
...
aaOut.out=aaOut.o[-1,]
write.csv(aaOut.out,"./train_P_CTDD.csv")
