#EMS-1b: Predicting structure, function, and other protein properties directly from a single sequence
...
need_data.to_csv('yaoyao-11/Seq-RBPpred/EMS-1b/test_NonRBPs_522.csv',encoding='gbk')
