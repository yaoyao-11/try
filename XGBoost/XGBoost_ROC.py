...
model = xgb.XGBClassifier(n_estimators=375, max_depth=3, min_child_weight= 1, seed= 0,learning_rate=0.1, subsample=0.8, colsample_bytree=0.8, gamma=0, reg_alpha=0,reg_lambda=1, silent=True)
